<?php
    ...
    if ($_POST) {
        ...
        if ($num1 == $num2) {
            ...
            if ($num1 == 5) {
             echo "El valor A es igual a 5 <br/>";
            }
            if ($num1 == 6) {
             echo "El valor A es igual a 6 <br/>";
            }
        }

        if ( ($num1 == $num2)&&( $num1 ==5) ) {
            echo "A es igual a B, A es igual a 5";
        }
...
<body>
    ...
    <div class="w-full max-w-xs">
        <form action="ejercicio10.php" method="post"  class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <div class="mb-4">
